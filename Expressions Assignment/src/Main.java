public class Main {
    public static void main(String args[]){
        ...
        */
        //Expression 1
        System.out.println((9 - 4)+ 10/2 - (4 - 8)/(double)3);
        System.out.println((5) + 10/2 - (4 - 8)/(double)3);
        System.out.println((5) + 10/2 - (-4)/(double)3);
        System.out.println(5 + 5 - (-4)/(double)3);
        System.out.println(10 - (-4/(double)3));
        System.out.println(11.333333333333334);
        //Expression 2
        ...
        System.out.println(3 + 81/(double)5);
